...
module.exports = function renderScripts() {
    ...
    */
    ...
    const FaSourcePath = path.resolve(path.dirname(__filename), '../node_modules/@fortawesome/fontawesome-free/js/all.min.js');
    const FaDestPath = path.resolve(path.dirname(__filename), '../dist/js/all.min.js');

    sh.cp('-R', FaSourcePath, FaDestPath)
};
